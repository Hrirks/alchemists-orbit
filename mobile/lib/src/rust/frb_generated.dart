...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -291526307;
...
abstract class RustLibApi extends BaseApi {
  void crateApiPhysicsConfigureLevel({
    int? maxDominoes,
  ...
  String? crateApiPhysicsCurrentLevelName();
  ...
  bool crateApiPhysicsLoadLevelJson({required String levelJson});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_opt_box_autoadd_u_32(maxDominoes, serializer);
          sse_encode_opt_box_autoadd_f_32(timeLimitSeconds, serializer);
        ...
        constMeta: kCrateApiPhysicsConfigureLevelConstMeta,
        argValues: [maxDominoes, timeLimitSeconds],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiPhysicsConfigureLevelConstMeta =>
      const TaskConstMeta(
        debugName: "configure_level",
        argNames: ["maxDominoes", "timeLimitSeconds"],
      );
  ...
  String? crateApiPhysicsCurrentLevelName() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiPhysicsCurrentLevelNameConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPhysicsCurrentLevelNameConstMeta =>
      const TaskConstMeta(debugName: "current_level_name", argNames: []);
  ...
  bool crateApiPhysicsLoadLevelJson({required String levelJson}) {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(levelJson, serializer);
        ...
        constMeta: kCrateApiPhysicsLoadLevelJsonConstMeta,
        argValues: [levelJson],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiPhysicsLoadLevelJsonConstMeta =>
      const TaskConstMeta(
        debugName: "load_level_json",
        argNames: ["levelJson"],
      );
